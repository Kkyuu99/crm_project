...
<body class="bg-neutral-50 font-[Poppins]">
    ...
    <span class="absolute text-white text-4xl top-5 left-4 cursor-pointer" onclick="Open()">
        <i class="bi bi-filter-left px-4 bg-purple-100 rounded-md"></i>
    </span>
    ...
    <div class="sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-[300px] overflow-auto text-center bg-purple-500">
        ...
        <!-- Sidebar Items -->
        <a href="#" onclick="loadContent('DashboardUser.html')">
...
<!-- Dropdown for Users -->
    ...
    <!-- Main Content Area -->
    <div id="main-content" class="ml-[300px] p-5">
        <h1 class="text-3xl">Welcome to the Dashboard!</h1>
