            ...
            <div class="w-1/2 p-8">
                ...
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between mb-4 ">
                        ...
                        <a href="{{ route('password.request') }}" class="text-violet-200 hover:underline text-sm">Forgot Password?</a>
                    </div>
                    ...
                    <div class="w-32 mx-auto">
                        ...
                        <button
                            type="submit"
                            class="bg-violet-400 text-white px-6 py-2 rounded-md hover:bg-violet-300 font-bold text-sm">
                            Login
                        </button>
                    </div>
                </form>
