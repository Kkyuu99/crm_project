<x-layout>
    ...
    <form class="w-full bg-white p-6 rounded-lg" action="{{ route($prefix . '.project-store') }}" method="post">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="project_name" required name="project_name" class="w-full px-4 py-2 p-1 text-slate-600 text-sm input-boxes" placeholder="Sample Name">
        </div>

        <div class="mb-4">
            <label class="font-normal text-black justify-start text-sm mb-2">Organization Name</label><br>
            <input type="text" id="organization_name" name="organization_name" class="w-full px-4 py-2 p-1 text-slate-600 text-sm input-boxes" placeholder="Sample Name">
        </div>

        <div class="flex gap-8">
            <div class="mb-4 ">
                <label class="font-normal text-black justify-start text-sm mb-2">Project Type</label><br>
                <SELECT name="project_type" required class="w-96 px-4 py-2 p-1 text-slate-600 text-sm input-boxes" placeholder="Sample Name">
            ...
            <div class="mb-4 px-0">
                ...
                <input type="text" id="project_manager" name="project_manager" class="w-full px-4 py-2 p-3 text-slate-600 text-sm input-boxes" placeholder="Sample Name">
            </div>
        </div>
        ...
        <div class="flex gap-8">
            <div class="mb-4">
                ...
                <input type="text" id="contact_name" name="contact_name" class="w-96 px-4 py-2 p-1 text-slate-600 text-sm input-boxes" placeholder="Sample Name">
            </div>
        ...
        <div class="flex gap-8">
            <div class="mb-4">
                ...
                <input type="text" id="contact_phone" name="contact_phone" class="input-boxes w-96 px-4 py-2 text-slate-600 text-sm" placeholder="+959-000000000">
            </div>
        ...
        <div class="flex gap-8">
            <div class="mb-4">
                ...
                <input type="text" id="contact_email" name="contact_email" class="w-96 px-4 py-2 p-1 text-slate-600 text-sm input-boxes" placeholder="Sample@gmail.com">
            </div>
            ...
            <div class="py-6 flex gap-2">
                ...
                <a href="{{ route($prefix . '.project-list') }}" class="cancel-btn">
                    Cancel
                </a>
            </div>
        </div>   
