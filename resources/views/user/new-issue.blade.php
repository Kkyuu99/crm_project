<x-layout>
    <h1 class="text-3xl font-bold text-black my-4 text-center">New Issue</h1>
        ...
        <form>
            ...
            <div class="mb-4 flex justify-between space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <select id="pri" class="w-full bg-white border border-gray-300 px-2 py-1 text-sm rounded-sm leading-tight focus:outline-none appearance-none">
                        <option value="high" class="bg-red-600 text-white">Low</option>
                        <option value="medium" class="bg-yellow-500 text-black">Medium</option>
                        <option value="medium" class="bg-yellow-500 text-black">High</option>
                    </select>
                </div>
                ...
                <div class="flex-1">
                    ...
                    <input type="text" id="assignor" class="w-full px-2 py-1 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>


                <div class="flex-1">
                    <label for="status" class="block text-black text-sm font-bold mb-2">Status</label>
                    <select id="status" class="w-full bg-white border border-gray-300 px-2 py-1 text-sm rounded-sm leading-tight focus:outline-none appearance-none">
            ...
            <div class="mb-4">
                ...
                <input type="file" id="attm" class="w-full px-4 py-2 rounded-lg border border-gray-g bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
