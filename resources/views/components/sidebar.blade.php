...
<div class="sidebar fixed space-y-5 top-0 bottom-0 lg:left-0 left-[-300px] p-2 w-[300px] overflow-auto text-center bg-purple-500">
    ...
    <a href="/user/dashboard"
            class="{{ request()->is('user/dashboard') ? 'bg-blue-50 text-blue-600' : 'text-white' }} group flex items-center px-3 py-2 rounded-md hover:bg-blue-50 hover:text-blue-600 transition-colors">
    ...
    <a href="/user/project-list"
            class="{{ request()->is('user/project-list') ? 'bg-blue-50 text-blue-600' : 'text-white' }} group flex items-center px-3 py-2 rounded-md hover:bg-blue-50 hover:text-blue-600 transition-colors">
            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
               <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="/user/issue-list"
            class="{{ request()->is('user/issue-list') ? 'bg-blue-50 text-blue-600' : 'text-white' }} group flex items-center px-3 py-2 rounded-md hover:bg-blue-50 hover:text-blue-600 transition-colors">
            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
               <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
